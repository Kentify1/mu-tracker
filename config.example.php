...
/**
 * MU Tracker Configuration Template
 * 
 * Copy this file to config.php and update with your settings
 * This file is safe to commit to GitHub as it contains no sensitive data
 */

// Database Configuration
$db_host = 'localhost';              // Your database host
$db_name = 'mu_tracker';             // Your database name
...
$is_production = isset($_SERVER['HTTP_HOST']) && !in_array($_SERVER['HTTP_HOST'], ['localhost', '127.0.0.1', '::1']);
